...
export const CHUNK_FILES: ChunkMetadata[] = [
 ...
 */
export function getChunkAndOffset(globalIndex: number): { chunkIndex: number; offset: number } | null {
 ...
 */
export function getGlobalIndex(chunkIndex: number, offset: number): number {
  let globalIndex = 0;
